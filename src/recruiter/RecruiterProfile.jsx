  ...
  return (
    <View style={{ padding: 20 }}>
      ...
      <Card style={{ marginBottom: 20, alignItems: 'center', padding: 32 }}>
        ...
        <Text style={{ fontSize: 14, color: accent, fontFamily: FONTS.bodyMedium, marginTop: 4 }}>{user.company}</Text>
      ...
      <Card style={{ marginBottom: 10, padding: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
          ...
          {(() => {
            ...
            return resumeUrl ? (
              <TouchableOpacity
                onPress={() => Linking.openURL(resumeUrl).catch(err => Alert.alert('Cannot Open', `Failed to open file.\n\n${resumeUrl}`))}
